...
class WithStateItemRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[WithStateItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_put_request_information(self,body: Optional[List[str]] = None, request_configuration: Optional[WithStateItemRequestBuilderPutRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def get(self,request_configuration: Optional[WithStateItemRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[List[todo_item.TodoItem]]:
        """
        Gets a list of Todo items of a specific state
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def put(self,body: Optional[List[str]] = None, request_configuration: Optional[WithStateItemRequestBuilderPutRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> None:
        """
        Changes the state of the specified list items
        Args:
            body: 
